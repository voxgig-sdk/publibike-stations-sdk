# PublibikeStations SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions PublibikeStationsSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both PublibikeStationsSDK(...) and PublibikeStationsSDK.test(...) become
#      PublibikeStationsSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "publibikestations_sdk"
_SDK_CLASS = "PublibikeStationsSDK"
