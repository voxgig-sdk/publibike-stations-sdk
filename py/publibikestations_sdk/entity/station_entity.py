...
from publibikestations_sdk.publibikestations_types import (
    Station,
    StationLoadMatch,
    StationListMatch,
)
...
class StationEntity:
    ...
    def list(self, reqmatch=None, ctrl=None) -> list[Station]:
        utility = self._utility
        # reqmatch is optional: an omitted match lists all records. Treat None
        # as an empty match so client.Station().list() works with no args.
        if reqmatch is None:
            reqmatch = {}
        ctx = utility.make_context({
            "opname": "list",
