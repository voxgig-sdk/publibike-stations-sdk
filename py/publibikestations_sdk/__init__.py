...
from publibikestations_sdk.utility import register

# Load features
from publibikestations_sdk.feature.base_feature import PublibikeStationsBaseFeature
from publibikestations_sdk.features import _has_feature, _make_feature
...
class PublibikeStationsSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = PublibikeStationsUtility()
    ...
    def get_utility(self):
        return PublibikeStationsUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("PublibikeStationsSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Station(self, data=None) -> "StationEntity":
        ...
        from publibikestations_sdk.entity.station_entity import StationEntity
