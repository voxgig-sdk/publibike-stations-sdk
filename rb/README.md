# PublibikeStations Ruby SDK



The Ruby SDK for the PublibikeStations API — an entity-oriented client using idiomatic Ruby conventions.
...
raise a `PublibikeStationsError` (a `StandardError` subclass), so wrap
...
```
rb/
├── PublibikeStations_sdk.rb       -- Main SDK module
