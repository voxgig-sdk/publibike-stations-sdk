...
class StationEntityTest < Minitest::Test
  ...
  def test_basic_flow
    ...
    if setup[:synthetic_only]
      skip "live entity test uses synthetic IDs from fixture — set PUBLIBIKESTATIONS_TEST_STATION_ENTID JSON to run live"
      return
    end
    client = setup[:client]
...
def station_basic_setup(extra)
  ...
  entid_env_raw = ENV["PUBLIBIKESTATIONS_TEST_STATION_ENTID"]
