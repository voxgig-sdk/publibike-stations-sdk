...
#      offline in seeded test mode (PublibikeStationsSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "PublibikeStations_sdk.rb")
  SDK_CLASS = "PublibikeStationsSDK"
  ...
  SDK_BASE = "PublibikeStations_sdk"
