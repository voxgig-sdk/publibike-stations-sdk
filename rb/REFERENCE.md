# PublibikeStations Ruby SDK Reference

Complete API reference for the PublibikeStations Ruby SDK.
...
#### `PublibikeStationsSDK.test(testopts = nil, sdkopts = nil)`
...
```ruby
results, err = client.Station.list(nil)
```
