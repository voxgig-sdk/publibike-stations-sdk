...
// instead of `sdk.NewPublibikeStationsSDK(nil)` / `sdk.TestSDK(nil, nil)`
// for the common no-options case.
func New() *PublibikeStationsSDK  { return NewPublibikeStationsSDK(nil) }
func Test() *PublibikeStationsSDK { return TestSDK(nil, nil) }
