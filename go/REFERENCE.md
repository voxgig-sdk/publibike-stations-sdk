# PublibikeStations Golang SDK Reference

Complete API reference for the PublibikeStations Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *PublibikeStationsSDK`
...
#### `Station(data map[string]any) PublibikeStationsEntity`
