...
boru-driven command-line client **and** interactive REPL for the PublibikeStations
...
- `<entity>` is a bareword, auto-quoted as an boru atom (e.g. `station`).
