...
func registerSDKWords(r *eng.Registry, client *sdk.PublibikeStationsSDK) {
...
func runOp(client *sdk.PublibikeStationsSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
