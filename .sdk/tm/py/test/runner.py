...
class PublibikeStationsTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = PublibikeStationsTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = PublibikeStationsTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = PublibikeStationsTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
