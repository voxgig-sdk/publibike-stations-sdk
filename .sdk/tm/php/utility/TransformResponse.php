...
// PublibikeStations SDK utility: transform_response

require_once __DIR__ . '/../core/Helpers.php';

class PublibikeStationsTransformResponse
{
    public static function call(PublibikeStationsContext $ctx): mixed
    {
        ...
        $transform = PublibikeStationsHelpers::to_map(\Voxgig\Struct\Struct::getprop($point, 'transform'));
        if (!$transform) {
            return null;
        }
