...
// PublibikeStations SDK clienttrack feature
...
class PublibikeStationsClienttrackFeature extends PublibikeStationsBaseFeature
{
    ...
    public function PostConstruct(PublibikeStationsContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'PublibikeStations-SDK';
