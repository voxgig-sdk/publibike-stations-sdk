...
// PublibikeStations SDK rbac feature
...
class PublibikeStationsRbacFeature extends PublibikeStationsBaseFeature
{
    ...
    private function _required(PublibikeStationsContext $ctx): ?string
    {
    ...
    private function _reject(PublibikeStationsContext $ctx, string $required): void
    {
    ...
    private function _track(PublibikeStationsContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
