...
// PublibikeStations SDK telemetry feature
...
class PublibikeStationsTelemetryFeature extends PublibikeStationsBaseFeature
{
    ...
    private function _close(PublibikeStationsContext $ctx, bool $ok): void
    {
