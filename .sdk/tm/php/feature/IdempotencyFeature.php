...
// PublibikeStations SDK idempotency feature
...
class PublibikeStationsIdempotencyFeature extends PublibikeStationsBaseFeature
{
    ...
    private function _mutating(PublibikeStationsContext $ctx): bool
    {
