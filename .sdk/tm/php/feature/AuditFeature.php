...
// PublibikeStations SDK audit feature
...
class PublibikeStationsAuditFeature extends PublibikeStationsBaseFeature
{
    ...
    private function _emit(PublibikeStationsContext $ctx, string $outcome): void
    {
