...
// PublibikeStations SDK timeout feature
...
class PublibikeStationsTimeoutFeature extends PublibikeStationsBaseFeature
{
    ...
    private function _with_timeout(PublibikeStationsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(PublibikeStationsContext $_ctx, float $ms): void
    {
        $client = $this->client;
