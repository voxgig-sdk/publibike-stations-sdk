...
// PublibikeStations SDK netsim feature
...
class PublibikeStationsNetsimFeature extends PublibikeStationsBaseFeature
{
    ...
    private function _simulate(PublibikeStationsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(PublibikeStationsContext $ctx, array $applied): void
    {
        $client = $this->client;
