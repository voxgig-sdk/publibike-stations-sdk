...
// PublibikeStations SDK cache feature
...
class PublibikeStationsCacheFeature extends PublibikeStationsBaseFeature
{
    ...
    private function _through(PublibikeStationsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
