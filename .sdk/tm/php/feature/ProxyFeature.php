...
// PublibikeStations SDK proxy feature
...
class PublibikeStationsProxyFeature extends PublibikeStationsBaseFeature
{
    ...
    public function init(PublibikeStationsContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (PublibikeStationsContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
