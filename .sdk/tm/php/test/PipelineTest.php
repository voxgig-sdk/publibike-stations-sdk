...
// PublibikeStations SDK pipeline test
//
...
{
    private static function utility(): PublibikeStationsUtility
    {
        return new PublibikeStationsUtility();
    }
    ...
    private static function ctx(array $over = []): PublibikeStationsContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new PublibikeStationsContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new PublibikeStationsOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof PublibikeStationsError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new PublibikeStationsOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = PublibikeStationsMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new PublibikeStationsOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = PublibikeStationsMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new PublibikeStationsOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = PublibikeStationsMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new PublibikeStationsSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = PublibikeStationsMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new PublibikeStationsResponse([]),
            'result' => new PublibikeStationsResult([]),
        ]);
        [, $err] = PublibikeStationsMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new PublibikeStationsSpec([]),
            'response' => null,
            'result' => new PublibikeStationsResult([]),
        ]);
        [, $err] = PublibikeStationsMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new PublibikeStationsSpec(['step' => 's']),
            'response' => new PublibikeStationsResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new PublibikeStationsResult([]),
        ]);
        [, $err] = PublibikeStationsMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new PublibikeStationsSpec(['step' => 's']),
            'response' => new PublibikeStationsResponse(self::resp(200, ['v' => 1])),
            'result' => new PublibikeStationsResult([]),
        ]);
        [, $err] = PublibikeStationsMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new PublibikeStationsSpec(['step' => 's']),
            'response' => new PublibikeStationsResponse(self::resp(200, ['v' => 2])),
            'result' => new PublibikeStationsResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        PublibikeStationsMakeResponse::call($ctx);
    ...
    {
        $preset = new PublibikeStationsResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new PublibikeStationsSpec([]),
            'response' => new PublibikeStationsResponse([]),
            'result' => new PublibikeStationsResult([]),
        ...
        [$got, $err] = PublibikeStationsMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new PublibikeStationsResult([])]);
        [, $err] = PublibikeStationsMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new PublibikeStationsSpec([]), 'result' => null]);
        [, $err] = PublibikeStationsMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new PublibikeStationsSpec(['step' => 's']),
            'result' => new PublibikeStationsResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new PublibikeStationsOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = PublibikeStationsMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new PublibikeStationsSpec(['step' => 's']),
            'result' => new PublibikeStationsResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new PublibikeStationsOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = PublibikeStationsMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new PublibikeStationsResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new PublibikeStationsSpec([]),
            'result' => new PublibikeStationsResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = PublibikeStationsMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = PublibikeStationsMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new PublibikeStationsError('boom', 'boom');
        $utility->fetcher = function (PublibikeStationsContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new PublibikeStationsSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = PublibikeStationsMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (PublibikeStationsContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = PublibikeStationsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(PublibikeStationsResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        PublibikeStationsMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (PublibikeStationsContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new PublibikeStationsSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = PublibikeStationsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new PublibikeStationsResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new PublibikeStationsSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = PublibikeStationsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = PublibikeStationsMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = PublibikeStationsMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new PublibikeStationsResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, PublibikeStationsDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new PublibikeStationsResult(['ok' => false])]);
        $this->expectException(PublibikeStationsError::class);
        PublibikeStationsDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new PublibikeStationsResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', PublibikeStationsMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        PublibikeStationsMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new PublibikeStationsBaseFeature();
        $b = new PublibikeStationsBaseFeature();
        PublibikeStationsFeatureAdd::call($ctx, $a);
        PublibikeStationsFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): PublibikeStationsBaseFeature
    {
        $f = new PublibikeStationsBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        PublibikeStationsFeatureAdd::call($ctx, self::named_feature('a'));
        PublibikeStationsFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        PublibikeStationsFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        PublibikeStationsFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        PublibikeStationsFeatureAdd::call($ctx, $replace);
        ...
        PublibikeStationsFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?array $headers): PublibikeStationsContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new PublibikeStationsSpec(['headers' => $headers]),
        ]);
    }
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = PublibikeStationsPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_a_raw_apikey_goes_in_as_is(): void
    {
        ...
        PublibikeStationsPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new PublibikeStationsResponse(['headers' => null]),
            'result' => new PublibikeStationsResult([]),
        ]);
        PublibikeStationsResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        PublibikeStationsResultBody::call($ctx);
