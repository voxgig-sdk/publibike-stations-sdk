...
type Args struct {
	Entity string         `json:"entity" jsonschema:"station"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.PublibikeStationsSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "publibike-stations_list",
		Description: "List records from PublibikeStations. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "publibike-stations_load",
		Description: "Load a single record from PublibikeStations. " +
...
func runOp(client *sdk.PublibikeStationsSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.PublibikeStationsSDK, name string) (sdk.PublibikeStationsEntity, error) {
