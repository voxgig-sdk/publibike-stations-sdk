// Command PublibikeStations-mcp is an MCP server exposing the PublibikeStations
// SDK as MCP tools.
//
// Two tools are registered:
//
//	PublibikeStations_list  — list records of an entity
//	PublibikeStations_load  — load a single record of an entity
//
