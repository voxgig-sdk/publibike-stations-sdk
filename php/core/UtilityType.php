...
// PublibikeStations SDK utility type

class PublibikeStationsUtility
{
    ...
    public static function copy(PublibikeStationsUtility $src): PublibikeStationsUtility
    {
        $u = new PublibikeStationsUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
