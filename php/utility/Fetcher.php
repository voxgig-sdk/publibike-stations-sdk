...
// PublibikeStations SDK utility: fetcher

class PublibikeStationsFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; PublibikeStationsSDK/1.0)';
    ...
    public static function call(PublibikeStationsContext $ctx, string $fullurl, array $fetchdef): array
    {
