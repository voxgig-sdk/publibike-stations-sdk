...
// PublibikeStations SDK utility: graphql
//
...
class PublibikeStationsGraphql
{
    ...
    // equivalent.
    public static function body(PublibikeStationsContext $ctx): mixed
    {
    ...
    public static function errors(PublibikeStationsContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
