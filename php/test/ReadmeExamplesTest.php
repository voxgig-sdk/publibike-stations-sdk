...
// PublibikeStations SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (PublibikeStationsSDK::test)
...
{
    private const SDK_CLASS = 'PublibikeStationsSDK';
    ...
    private const SDK_BASE = 'publibikestations_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../publibikestations_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
