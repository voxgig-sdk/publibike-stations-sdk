...
// PublibikeStations SDK debug feature
...
class PublibikeStationsDebugFeature extends PublibikeStationsBaseFeature
{
    ...
    private function _finish(PublibikeStationsContext $ctx, bool $ok): void
    {
