...
// PublibikeStations SDK ratelimit feature
...
class PublibikeStationsRatelimitFeature extends PublibikeStationsBaseFeature
{
    ...
    private function _acquire(PublibikeStationsContext $ctx): void
    {
    ...
    private function _track(PublibikeStationsContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
