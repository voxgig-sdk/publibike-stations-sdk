...
// PublibikeStations SDK metrics feature
...
class PublibikeStationsMetricsFeature extends PublibikeStationsBaseFeature
{
    ...
    private function _record(PublibikeStationsContext $ctx, bool $ok): void
    {
