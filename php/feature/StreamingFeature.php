...
// PublibikeStations SDK streaming feature
...
class PublibikeStationsStreamingFeature extends PublibikeStationsBaseFeature
{
    ...
    private function _iterate(PublibikeStationsResult $result): \Generator
    {
    ...
    private function _streamable(PublibikeStationsContext $ctx): bool
    {
