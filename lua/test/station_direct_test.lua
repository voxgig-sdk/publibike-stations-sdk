...
describe("StationDirect", function()
  it("should direct-list-station", function()
    local setup = station_direct_setup({
      { id = "direct01" },
      { id = "direct02" },
    })
    local _should_skip, _reason = runner.is_control_skipped("direct", "direct-list-station", setup.live and "live" or "unit")
